  ...
  <div class="home">
    ...
    <div v-else class="container movies">
      ...
      <div v-if="searchInput !== ''" id="movie-grid" class="movies-grid">
        <div v-for="(movie, idx) in searchMovies" :key="idx" class="movie">
          <div class="movie-img">
            <img
              :src="`https://image.tmdb.org/t/p/w500/${movie.poster_path}`"
              alt=""
            />
            <p class="reeview">{{ movie.vote_average }}</p>
...
export default {
  ...
  head() {
    return {
      title: 'Clone Moive Web',
      meta: [
        {
          hid: 'dsecirption',
          name: 'description',
          content: 'meta description content text',
        },
        {
          hid: 'keywords',
          name: 'keywords',
          content: 'meta keyword content text',
        },
      ],
    };
  },
  ...
  methods: {
    async getMovies() {
      ...
      result.data.results.forEach((movie, index) => {
